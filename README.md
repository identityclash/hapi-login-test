...
[![Build Status](https://travis-ci.org/identityclash/hapi-login-test.svg)](https://travis-ci.org/identityclash/hapi-login-test) [![Coverage Status](https://coveralls.io/repos/github/identityclash/hapi-login-test/badge.svg)](https://coveralls.io/github/identityclash/hapi-login-test) [![Code Climate](https://codeclimate.com/github/identityclash/hapi-login-test/badges/gpa.svg)](https://codeclimate.com/github/identityclash/hapi-login-test) [![Known Vulnerabilities](https://snyk.io/test/github/identityclash/hapi-login-test/badge.svg)](https://snyk.io/test/github/identityclash/hapi-login-test)
